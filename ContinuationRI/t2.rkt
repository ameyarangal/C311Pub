...
#|
First step, grab the inner continuation in the `(,rator ,rand) line,
wrap it in a global function called make-arg-k,
and make sure all free variables are captured.
|#
