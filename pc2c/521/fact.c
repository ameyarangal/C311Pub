...
if(!_data) {
  ...
  _data->tag = _maker__m__factr__m__k_continuation;
  _data->u._maker__m__factr__m__k._n = n;
  _data->u._maker__m__factr__m__k._k = k;
  return (void *)_data;
}
...
pc = &applyr__m__k;
  ...
  factr__m__k = (void *)continuationr_maker__m__factr__m__k(factr__m__n,factr__m__k);
...
break; }
case _maker__m__factr__m__k_continuation: {
void *n = _c->u._maker__m__factr__m__k._n;
void *k = _c->u._maker__m__factr__m__k._k;
